...
export const siteConfig = {
  ...
  location: {
    ...
    region: "Chicago's premier western suburbs",
  ...
  // Local Landmarks & References (Naperville-specific)
  localLandmarks: {
    famous: [
      {
  ...
  // SEO Keywords (Naperville-specific)
  seo: {
    primaryKeywords: [
  ...
  // Page-specific content (Naperville-customized)
  pages: {
    home: {
